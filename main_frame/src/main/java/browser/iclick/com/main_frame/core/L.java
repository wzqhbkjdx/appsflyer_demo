...
public final class L {
	 ...
	 * injecting a logger instance rather than using static methods or to facilitate
	 * testing.
	 */
	...
	public static abstract class Tree {
		...
		private void prepareLog(int priority, Throwable t, String message, Object... args) {
			// Consume tag even when message is not loggable so that next message is
			// correctly tagged.
			String tag = getTag();
		...
		/**
		 * Write a log message to its destination. Called for all level-specific methods
		 * by default.
		 *
		 * @param priority
		 ...
		 * @param message
		 *            Formatted log message. May be {@code null}, but then {@code t}
		 *            will not be.
		 * @param t
		 *            Accompanying exceptions. May be {@code null}, but then
		 *            {@code message} will not be.
		 */
		protected abstract void log(int priority, String tag, String message, Throwable t);
	}

	/**
	 * A {@link Tree Tree} for debug builds. Automatically infers the tag from the
	 * calling class.
	 */
	public static class DebugTree extends Tree {
		 ...
		 * {@code element}. By default this will use the class name without any
		...
		@Override final String getTag() {
			...
			// DO NOT switch this to Thread.getCurrentThread().getStackTrace(). The test
			// will pass
			// because Robolectric runs them on the JVM but on Android the elements are
			// different.
		 ...
		 * either {@link Log#println(int, String, String) Log.println()} or
