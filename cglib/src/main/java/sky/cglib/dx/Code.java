...
import static sky.cglib.dx.rop.code.Rop.BRANCH_GOTO;
import static sky.cglib.dx.rop.code.Rop.BRANCH_NONE;
import static sky.cglib.dx.rop.code.Rop.BRANCH_RETURN;
import static sky.cglib.dx.rop.type.Type.BT_BYTE;
import static sky.cglib.dx.rop.type.Type.BT_CHAR;
import static sky.cglib.dx.rop.type.Type.BT_INT;
import static sky.cglib.dx.rop.type.Type.BT_SHORT;
...
import sky.cglib.dx.rop.code.BasicBlockList;
import sky.cglib.dx.rop.code.Insn;
import sky.cglib.dx.rop.code.PlainCstInsn;
import sky.cglib.dx.rop.code.PlainInsn;
import sky.cglib.dx.rop.code.RegisterSpecList;
import sky.cglib.dx.rop.code.Rop;
import sky.cglib.dx.rop.code.Rops;
import sky.cglib.dx.rop.code.SourcePosition;
import sky.cglib.dx.rop.code.ThrowingCstInsn;
import sky.cglib.dx.rop.code.ThrowingInsn;
import sky.cglib.dx.rop.cst.CstInteger;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(sky.cglib.dx.rop.type.Type sourceType,
            sky.cglib.dx.rop.type.Type targetType) {
