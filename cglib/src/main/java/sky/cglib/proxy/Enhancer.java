...
public class Enhancer {
	...
	public Object create() {
		...
		// System.out.println("[Enhancer::create()] Create class extends from \"" +
		// superclass.getName() + "\" stored in " + cacheDir);
	...
	@SuppressWarnings({ "unchecked", "rawtypes" }) private <S> void generateFieldsAndMethods(DexMaker dexMaker, TypeId<?> superType, TypeId<S> subType) {
